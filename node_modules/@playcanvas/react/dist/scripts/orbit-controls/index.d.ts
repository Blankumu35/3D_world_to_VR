...
export declare const OrbitControls: ({ distanceMax, distanceMin, pitchAngleMax, pitchAngleMin, inertiaFactor, focusEntity, pivotPoint, frameOnStart, distance, mouse, touch, }: OrbitControls) => import("react").JSX.Element;
export {};
