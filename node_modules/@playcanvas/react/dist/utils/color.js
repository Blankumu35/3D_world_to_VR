...
import { getPseudoPublicProps } from "./validation.js";
...
export const getColorFromName = (name) => {
    return cssColorNames.has(name) && cssColorNamesMap[name];
};
/**
 ...
 */
export const getColorPropertyNames = (target) => {
    const allPublicProps = getPseudoPublicProps(target);
    const colorNames = Object.entries(allPublicProps).reduce((arr, [name, value]) => {
