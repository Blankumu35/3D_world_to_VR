import { platform, DEVICETYPE_WEBGL2, DEVICETYPE_WEBGPU, DEVICETYPE_NULL, NullGraphicsDevice, WebglGraphicsDevice, WebgpuGraphicsDevice } from "playcanvas";
/**
...
export async function internalCreateGraphicsDevice(canvas, options = {}) {
    ...
    const deviceCreateFuncs = deviceTypes.map((deviceType) => {
        // @ts-expect-error - navigator is not defined in the test environment
...
//# sourceMappingURL=create-graphics-device.js.map